...
% affiliations
\author{\IEEEauthorblockN{Kaiqiang Jiang, Yi Ao, Ping Huang, Hui Zan, Dehui Du*}
\IEEEauthorblockA{Shanghai Key Laboratory of Trustworthy Computing, School of Computer Science and Software Engineering,\\ East China Normal University, Shanghai, 200062, China\\
...
\end{abstract}
\begin{IEEEkeywords}
Statistical model checking, Statistical abstraction, Learning, Distributed technology, Bayesian interval estimation algorithm
\end{IEEEkeywords}

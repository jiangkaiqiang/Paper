...
\begin{figure}[htbp]
\centering{
		\subfigure[Timed automata for fixed step algorithm]{\includegraphics[width=1.5in,height=1.0in]{fig/fixedstep_master.png}
			\label{ta_fixedstep}}
		\hfil
		\subfigure[Timed automata for rollback algorithm]{\includegraphics[width=3.0in,height=1.5in]{fig/rollback_master.png}
			\label{ta-rollback}}		
	\caption{Timed automata for fixed step algorithm and rollback algorithm.}
	\label{ta-rollfix}
	}
\end{figure}
\begin{figure}[htbp]

...
\item
$E \subseteq L \times G(X) \times Act \times 2^X \times L$ is a set of edges labelled with guards and a set of clocks, where $Act = Act_{i} \cup Act_{o}$. $Act_{i}$ is a set of input actions and $Act_{o}$ is a set of output actions.
\item

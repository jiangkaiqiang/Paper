...
\begin{figure}[htbp]
	\centering	{\includegraphics[width=2.2in,height=1.5in]{fig/tank-fig.pdf}}
...
\begin{figure}[htbp]
\centering{
		\subfigure[Connection case1]{\includegraphics[width=3.2in,height=0.8in]{fig/CD1.png}
			\label{cd1}}
		\hfil
		\subfigure[Connection case2]{\includegraphics[width=3.2in,height=0.8in]{fig/CD2.png}
			\label{cd2}}
		\hfil
		\subfigure[Connection case3]{\includegraphics[width=3.2in,height=0.8in]{fig/CD3.png}
			\label{cd3}}
...
\begin{figure}[htbp]
\centering{
		\subfigure[Connection case1]{\includegraphics[width=1.0in,height=0.6in]{fig/fmuc1.png}
			\label{fmu-con1}}
		\hfil
		\subfigure[Connection case2]{\includegraphics[width=1.0in,height=0.6in]{fig/fmuc2.png}
			\label{fmu-con2}}
		\hfil
		\subfigure[Connection case3]{\includegraphics[width=1.0in,height=0.6in]{fig/fmuc3.png}
			\label{fmu-con3}}

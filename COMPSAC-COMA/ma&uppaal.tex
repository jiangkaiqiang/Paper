...
\begin{figure}[htbp]
\centering{
		\subfigure[TA template for FMU\_controller]{\includegraphics[width=1.6in,height=1.0in]{fig/2signal_controller.png}
			\label{tk_controller}}
		\hfil

...
\begin{figure}[htbp]
\centering{
		\subfigure[Sketch map of water tank system]{\includegraphics[width=1.0in,height=0.6in]{fig/tank-fig.pdf}
			\label{wts-sm}}
		\hfil
		\subfigure[FMUs connection of water tank system.]{\includegraphics[width=1.7in,height=0.6in]{fig/tank-fra.pdf}
			\label{wts-fc}}

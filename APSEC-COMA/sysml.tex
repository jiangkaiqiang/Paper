...
\begin{figure}[htbp]
\centering{
		\subfigure[Sketch map of water tank system]{\includegraphics[width=1.2in,height=1.0in]{fig/tank-fig.pdf}
			\label{wts-sm}}
		\hfil
		\subfigure[FMUs connection of water tank system.]{\includegraphics[width=2.0in,height=0.8in]{fig/tank-fra.pdf}
			\label{wts-fc}}
...
\begin{figure}[htbp]
\centering{
		\subfigure[SysML BDD]{\includegraphics[width=3.2in,height=2.3in]{fig/AD.jpg}
			\label{trs}}
		\hfil
		\subfigure[SysML CD]{\includegraphics[width=3.2in,height=2.3in]{fig/CD.jpg}
			\label{seq}}

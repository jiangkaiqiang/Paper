...
UPPAAL uses a simplified version of TCTL \cite{BouchenebGR09} to express the requirement specification. We verify the following properties of each connection case:
\begin{itemize}
\item

...
\begin{figure}[htbp]
\centering{
		\subfigure[Timed automata template for FMU controller]{\includegraphics[width=2.0in,height=1.5in]{fig/2signal_controller.png}
			\label{tk_controller}}
		\hfil
		\subfigure[Timed automata for FMU valve]{\includegraphics[width=2.5in,height=1.5in]{fig/2signal_v.png}
			\label{tk_v}}
			
	    \subfigure[Timed automata for FMU tank1]{\includegraphics[width=2.0in,height=1.5in]{fig/2signal_wt1.png}
			\label{tk_wt1}}
		\hfil
		 \subfigure[Timed automata for master algorithm]{\includegraphics[width=2.5in,height=1.5in]{fig/2signal_master.png}
			\label{tk_ma}}		
...
\begin{figure}[htbp]
\centering{
		\subfigure[Execution trace]{\includegraphics[width=2.5in,height=2.7in]{fig/trs.jpg}
			\label{trs}}
		\hfil
		\subfigure[Execution sequence diagram]{\includegraphics[width=2.5in,height=2.7in]{fig/seq.jpg}
			\label{seq}}
...
\begin{figure}[htbp]
\centering{
		\subfigure[Timed automata for FMU controller]{\includegraphics[width=2.5in,height=1.5in]{fig/2signal_cycle_controller.png}
			\label{tk2_controller}}
		\hfil
		\subfigure[Timed automata for FMU tank1]{\includegraphics[width=2.0in,height=1.5in]{fig/2signal_cycle_wt1.png}
			\label{tk2_v}}		
...
\end{figure}
\begin{figure}[htbp]
	\centering	{\includegraphics[width=5.5in,height=1.3in]{fig/4signal_wt2.png}}

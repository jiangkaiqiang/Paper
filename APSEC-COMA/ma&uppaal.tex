...
\centering{
		...
		\hfil
		 \subfigure[Timed automata for master algorithm]{\includegraphics[width=1.7in,height=1.2in]{fig/2signal_master.png}
			\label{tk_ma}}		
	\caption{Network of TA for connection case 1: $TA_{controller} || TA_{valve} || TA_{tank1} || TA_{ma}$.}
	\label{tk-arch1}
	}
\end{figure}
...
\centering{
		...
		\subfigure[Timed automata for FMU tank1]{\includegraphics[width=1.5in,height=1.2in]{fig/2signal_cycle_wt1.png}
			\label{tk2_v}}		
	\caption{Network of TA for connection case 2: $TA_{controller} || TA_{valve} || TA_{tank1} || TA_{ma}$.}
	\label{tk-arch2}
	}
\end{figure}
\begin{figure}[htbp]

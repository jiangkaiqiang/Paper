...
\begin{figure}[htbp]
\centering{
		\subfigure[Timed automata template for FMU controller]{\includegraphics[width=1.6in,height=1.2in]{fig/2signal_controller.png}
			\label{tk_controller}}
		\hfil
		\subfigure[Timed automata for FMU valve]{\includegraphics[width=1.6in,height=1.2in]{fig/2signal_v.png}
			\label{tk_v}}
...
\begin{figure}[htbp]
\centering{
		\subfigure[Execution trace]{\includegraphics[width=1.6in,height=1.8in]{fig/trs.jpg}
			\label{trs}}
		\hfil
		\subfigure[Execution sequence diagram]{\includegraphics[width=1.6in,height=1.8in]{fig/seq.jpg}
			\label{seq}}
...
\end{figure}
\begin{figure}[htbp]
	\centering	{\includegraphics[width=3.0in,height=0.8in]{fig/4signal_wt2.png}}

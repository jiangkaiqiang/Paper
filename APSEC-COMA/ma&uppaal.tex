...
\begin{figure}[htbp]
\centering{
		\subfigure[Timed automata template for FMU controller]{\includegraphics[width=1.3in,height=0.8in]{fig/2signal_controller.png}
			\label{tk_controller}}
		\hfil
		\subfigure[Timed automata for FMU valve]{\includegraphics[width=1.3in,height=0.8in]{fig/2signal_v.png}
			\label{tk_v}}
			
	    \subfigure[Timed automata for FMU tank1]{\includegraphics[width=1.2in,height=0.8in]{fig/2signal_wt1.png}
			\label{tk_wt1}}
		\hfil
		 \subfigure[Timed automata for master algorithm]{\includegraphics[width=1.4in,height=0.8in]{fig/2signal_master.png}
			\label{tk_ma}}		
...
\begin{figure}[htbp]
\centering{
		\subfigure[Execution trace]{\includegraphics[width=1.3in,height=1.4in]{fig/trs.jpg}
			\label{trs}}
		\hfil
		\subfigure[Execution sequence diagram]{\includegraphics[width=1.3in,height=1.4in]{fig/seq.jpg}
			\label{seq}}
...
\begin{figure}[htbp]
\centering{
		\subfigure[Timed automata for FMU controller]{\includegraphics[width=1.4in,height=0.8in]{fig/2signal_cycle_controller.png}
			\label{tk2_controller}}
		\hfil
		\subfigure[Timed automata for FMU tank1]{\includegraphics[width=1.2in,height=0.8in]{fig/2signal_cycle_wt1.png}
			\label{tk2_v}}		
...
\end{figure}
\begin{figure}[htbp]
	\centering	{\includegraphics[width=2.5in,height=0.7in]{fig/4signal_wt2.png}}

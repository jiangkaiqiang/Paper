...
\centering{
	    ...
	    \subfigure[Timed automata for FMU Water tank1]{\includegraphics[width=1.5in,height=1.2in]{fig/2signal_wt1.png}
			\label{tk_wt1}}
		\hfil
		 \subfigure[Timed automata for rollback master algorithm]{\includegraphics[width=1.7in,height=1.2in]{fig/2signal_master.png}
			\label{tk_ma}}		
	\caption{Network for TA of connection case 1: \emph{TA \_{controller}} $\vert\vert$ \emph{TA \_{valve}} $\vert\vert$ \emph{TA \_{Water tank1}} $\vert\vert$ \emph{TA \_{ma}}.}
	\label{tk-arch1}
	}
\end{figure}
...
\centering{
		...
		\hfil
		\subfigure[Timed automata for FMU Water tank1]{\includegraphics[width=1.5in,height=1.2in]{fig/2signal_cycle_wt1.png}
			\label{tk2_v}}		
	\caption{Templates of connection case 2.}
	\label{tk-arch2}
	}
\end{figure}
\begin{figure}[htbp]

\section{Background}
\label{sec:fmi}
In this section, we present the syntax and semantics of FMU and timed automaton separately. Based on their semantics, we propose to encode FMUs using timed automata in Section \ref{sec:encoding}. 

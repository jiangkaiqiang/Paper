...
\begin{figure}[htbp]
\centering{
		\subfigure[情形1]{\includegraphics[width=4.5in,height=1.0in]{fig/3/CD1.png}
			\label{cd1}}
		\hfil
		\subfigure[情形2]{\includegraphics[width=4.5in,height=1.0in]{fig/3/CD2.png}
			\label{cd2}}
		\hfil
		\subfigure[情形3]{\includegraphics[width=4.5in,height=1.0in]{fig/3/CD3.png}
			\label{cd3}}
